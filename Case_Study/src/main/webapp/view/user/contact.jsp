        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>Liên hệ</h1>
                    <p class="mb-4">Bạn cần tư vấn tìm phòng trọ phù hợp, đặt lịch xem phòng hoặc hỗ trợ hợp đồng?
                        Hãy để chúng tôi hỗ trợ bạn nhanh chóng và hoàn toàn miễn phí.</p>
                    <p><a href="" class="btn btn-secondary me-2">Tư vấn ngay</a><a href="room.html" class="btn btn-white-outline">Xem phòng</a></p>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="hero-img-wrap">
                    <img src="img_house/home1.png" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8 col-lg-8 pb-4">
                    ...
                    <div class="row mb-5">
                        <div class="col-lg-4">
                            <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                                ...
                                <div class="service-contents">
                                    <p>999 Dien Bien Phu. Da Nang, Viet Nam</p>
                        ...
                        <div class="col-lg-4">
                            <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                                ...
                                <div class="service-contents">
                                    <p>nguyenhieu1952005@gmail.com</p>
                                </div> <!-- /.service-contents-->
                            </div> <!-- /.service -->
                        </div>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="text-black" for="lname">Tên đẹm</label>
